...
using DesignPatterns.Curso.PatternsComportamental.Observer.Observers;
using DesignPatterns.Curso.PatternsComportamental.Observer.Subjects;

namespace DesignPatterns.Curso.PatternsComportamental.Observer
{
